...
I build systems that close the gap between LLM capability and production reality. Second year CS undergrad at IIIT Kota — shipped 17+ GenAI applications across legal intelligence, multi-agent translation, RLHF pipelines, and financial multimodal RAG.
...
**[Levi — Legal Document Intelligence](https://github.com/cherry51015/Levi-legal_AI_assistant)**

153K+ clause FAISS index. Multilingual semantic Q&A, compliance verification, automated briefing. FastAPI + Gemini + GCP Cloud Run. 89% answer relevance, sub-200ms latency. Hallucination guardrails via strict document-grounding.

`FastAPI` `FAISS` `Gemini` `GCP` `RAG`
...
**[FinSight — Multimodal Financial RAG](https://github.com/cherry51015)**

KPI extraction and chart understanding from financial reports. 91% numerical accuracy. Serverless architecture on AWS Lambda.

`Amazon Bedrock` `Claude` `Lambda` `RAG`
...
<img src="https://skillicons.dev/icons?i=python,pytorch,tensorflow,fastapi,docker,aws,gcp,postgres,git&theme=dark&perline=9" />
